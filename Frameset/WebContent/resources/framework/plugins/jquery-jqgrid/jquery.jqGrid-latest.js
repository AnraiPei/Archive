 ...
 *  默认斑马线
 */
function loadZebraStripling(){
	$('tr.jqgrow:odd').css('background','#F7EFDA');
	$('tr.jqgrow:odd').css('border','1px solid #999999');
}
 ...
 */
var AutoResize = function(options) {
	alert(222);
	var defaults = {
		gridContainer: 'body',
		filterToolbar: false,
